...
import type { EvaluationStatus, InspectionRequest, OverallInspectionResult } from '../../domain/types.js';
...
export function evaluateInspectionCompleteWithCurrentRules(r: InspectionRequest): OverallInspectionResult {
  const base = evaluateLegalInspection(r);
